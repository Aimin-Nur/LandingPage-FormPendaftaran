    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="/blog-sirah" class="active">Blog</a></li>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <div class="post-img">
                <img src="{{asset('pesantren')}}/assets/img/blog/kisah-2.jpeg" alt="" class="img-fluid w-100">
              </div>

              <h2 class="title">Siroh dan Tarikh
                Siapa Rasulullah serta Masa Kecil Beliau Shallallahu ‘Alaihi Wa Sallam</h2>

              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-details.html">Tauhidin Ali Rusdi Sahal</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details.html"><time
                        datetime="2020-01-01">18 Desember 2010</time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="blog-details.html">Artikel dan Kajian Islam</a></li>
                </ul>
              </div><!-- End meta top -->
              ...
              <div class="content">
                ...
                <h3>Peristiwa Pembelahan Dada.</h3>
                <p>
                ...
                <img src="assets/img/blog/kisah-3.jpeg" class="img-fluid" alt="">
