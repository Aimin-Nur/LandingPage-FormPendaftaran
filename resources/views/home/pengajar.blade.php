...
<main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url({{ asset('pesantren/assets/img/footer-new.jpeg')}}">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        ...
        <h1 class="text-white">Profil Pengajar</h1>
        <ol>
          <li><a href="/">Home</a></li>
          ...
          <div class="row gy-4">
            ...
            <div class="col-xl-12 col-xl-6 text-center" data-aos="fade-up" data-aos-delay="100">
              <div class="service-item  position-relative">
                ...
                <h3>Staff & Tenaga Pengajar</h3>
                <p style="font-size: 15px">Saat ini staf dan tenaga pengajar Pesantren Islam Al-Irsyad Tengaran Cabang Gorontalo terdiri dari 2 orang mufad Sudan (tenaga pengajar dari Sudan untuk membantu kegiatan belajar mengajar); alumni timur tengah baik dari Madinah, Mesir, Sudan, alumni STIBA Arrayah, alumni ma’had tahfidz, alumni Pesantren Islam Al-Irsyad; alumni Perguruan Tinggi dalam negeri yang terakreditasi.
                </p>
              </div>
